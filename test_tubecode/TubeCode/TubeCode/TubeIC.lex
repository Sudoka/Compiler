...
void LexMain(int argc, char * argv[])
{
  for (int arg_id = 1; arg_id <= argc; arg_id++) {
    ...
    if (cur_arg == "-h") {
      cout << "Tubulic (Tubular Intermediate Code) v. 0.1"  << endl
    ...
    if (cur_arg == "-i") {
      ...
      cout << "  " << cInst_PUSH_NUM::GetDesc() << endl;
      cout << "  " << cInst_POP_NUM::GetDesc() << endl;
      cout << "  " << cInst_AR_GET_IDX::GetDesc() << endl;
      cout << "  " << cInst_AR_SET_IDX::GetDesc() << endl;
      cout << "  " << cInst_AR_GET_SIZ::GetDesc() << endl;
      cout << "  " << cInst_AR_SET_SIZ::GetDesc() << endl;
      cout << "  " << cInst_AR_COPY::GetDesc() << endl;
      exit(0);
    }
